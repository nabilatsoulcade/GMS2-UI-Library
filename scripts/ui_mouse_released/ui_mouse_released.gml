///ui_mouse_released(x,y,sprite,window_width,window_height,base_width,base_height,draw,mouse_button)
var x_per = argument0;
var y_per = argument1;
...
return (point_in_rectangle(device_mouse_x_to_gui(0),device_mouse_y_to_gui(0),x1,y1,x2,y2) && mouse_check_button_pressed(mouse_but));
